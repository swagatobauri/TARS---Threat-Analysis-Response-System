...
type Approval = {
  id: string;
  proposed_action: "BLOCK" | "FLAG" | string;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[#888] text-sm font-mono">
            Human-in-the-loop validation for high-impact defensive actions.
          </p>
        </div>
      </div>
      ...
      {pendingApprovals.length === 0 ? (
        <div className="border border-[#1a1a1a] bg-[#0c0c0c] rounded-lg p-12 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[#666] text-sm">
            TARS is handling detections autonomously based on current safety
            thresholds.
          </p>
        </div>
      ) : (
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <span
                        className={`px-2 py-0.5 text-xs font-bold font-mono rounded ${
                          approval.proposed_action === "BLOCK"
                      ...
                      {approval.confidence_score > 0.95 && (
                    ...
                    <p className="text-xs text-[#666] font-mono mt-1">
                      Threat Event ID: {approval.threat_event_id}
                    </p>
                  </div>
                    ...
                    {rejectingId === approval.id ? (
                      <div className="flex w-full gap-2 items-center">
                        ...
                        <button
                          ...
                          className="bg-[#cc0000] hover:bg-[#ff0000] disabled:opacity-50 text-white px-4 py-1.5 rounded font-mono text-sm transition-colors flex items-center gap-2"
                        >
                          Confirm Reject
                        </button>
